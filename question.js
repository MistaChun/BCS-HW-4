// Create a landing page with timer set at 0, "start quiz" button, and "view highscores" button

// Once the start button is pressed, timer starts at a different value and counts down

// Make questions come out with eventlistener once start button is clicked

// Score is calculated by remainder of time and how many correct so find a way to display and calculate

// Once quiz is over, score is stored in local storage - store it in local storage
